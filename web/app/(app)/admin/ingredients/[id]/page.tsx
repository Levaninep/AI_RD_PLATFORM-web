...
import EditIngredientClient from "@/components/admin/ingredients/EditIngredientClient";

export const dynamic = "force-dynamic";

export default async function EditAdminIngredientPage({
  params,
}: {
  ...
  if (!session && !isDevAuthBypassEnabled()) {
    redirect(`/login?callbackUrl=/admin/ingredients/${id}`);
  }
